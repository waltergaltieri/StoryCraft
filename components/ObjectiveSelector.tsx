  ...
  return (
    <div className="space-y-10 sm:space-y-12">
      ...
      <div className="text-center space-y-3 sm:space-y-4">
        ...
        <p className="text-lg sm:text-xl text-slate-300 px-4 sm:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4">
          {OBJECTIVES_ES.map((obj) => (
            <button
              ...
              className={`p-4 sm:p-6 cursor-pointer transition-all duration-200 hover:scale-105 border-2 rounded-xl text-left ${
                objective === obj.id
